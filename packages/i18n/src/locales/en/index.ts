export const en = {
  ...
  chat: {
    ...
    usageProviderUsage: "Usage & Pricing",
    usageExact: "reported",
    usageInput: "Input",
    usageOutput: "Output",
    ...
    permissionAuto: "Approve routine actions",
    permissionFullAccess: "Full access",
    permissionFullAccessTitle: "Enable Full access?",
    permissionFullAccessDescription: "The agent can perform eligible actions without normal approval prompts. Existing safety and policy restrictions still apply.",
    permissionFullAccessFiles: "Files: create, edit, or delete files the agent can reach.",
    permissionFullAccessTerminal: "Terminal: run commands without asking each time.",
    permissionFullAccessInternet: "Internet and connected tools: send requests or use enabled integrations.",
    permissionFullAccessSensitiveData: "Sensitive data: content may be exposed to tools or services.",
    permissionFullAccessPromptInjection: "Prompt injection: untrusted content may try to influence the agent.",
    permissionFullAccessConfirm: "Enable Full access",
    modePlan: "Plan",
    modeGoal: "Goal",
    modeAgent: "Agent",
    thinking: "Thinking",
  ...
  settings: {
    ...
    delete: "Delete",
    theme: "Theme",
    themeFromPlugin: "Theme from plugin",
    mode: "Default mode",
    back: "Back",
    ...
    nav: {
      ...
      usagePricing: "Usage & Pricing",
      tokens: "Tokens",
      usageDescription: "Review completed-turn token usage from the local Nexus host.",
      usageEyebrow: "Nexus telemetry",
      usageHeadline: "Usage at a glance",
      usageTokensInRange: "in selected range",
      usageCompleted: "completed",
      usageProviderInput: "provider input",
      usageProviderOutput: "provider output",
      usageActivity: "Activity",
      usageActivityHint: "Token volume by period",
      usageLatest: "Latest period",
      usageLatestHint: "Most recent completed bucket",
      ...
      usageTurns: "Completed turns",
      usageHistory: "Usage history",
      usageBreakdown: "Token breakdown",
      usageMix: "Token mix",
      usageMixHint: "Share of completed-turn volume",
      usageRhythm: "Rhythm",
      usageRhythmHint: "Token volume by period",
      usagePeriods: "periods",
      usagePeriodsTitle: "Recent periods",
      usagePeriodsHint: "Completed-turn activity",
      usageTurnsShort: "turns",
      usageTurnsTitle: "Completed turns",
      usageTurnsHint: "Durable host rollup",
      usageAverage: "Average per turn",
      usagePluginTitle: "Token Insights",
      usageHeroSub: "{{turns}} completed turns · local usage",
      usageGreeting: "Good afternoon — here is what you and your tools have written.",
      usageHeroStats: "tokens · {{turns}} replies · {{sessions}} sessions · {{days}} active days",
      usageStreak: "{{current}}-day streak",
      usageLongest: "Longest {{longest}}",
      usageMilestoneReached: "{{value}} reached on {{date}}",
      usageBestDay: "Your best day so far was {{date}}, at {{tokens}} tokens. You do your loudest thinking around {{hour}}.",
      usageNextMilestone: "Next milestone {{value}}",
      usageMilestoneRemaining: "{{value}} to go",
      usageFilters: "Usage filters",
      usageAllTools: "All tools",
      usageAllModels: "All models",
      usageAllProviders: "All providers",
      usageFilterPlaceholder: "Filter by model, provider, tool or session",
      usageClearFilters: "Clear filters",
      usageModelsTitle: "Models",
      usageModelsHint: "Models in this window",
      usageToolsTitle: "Tools",
      usageToolsHint: "Sources in this window",
      usageSessionsTitle: "Busiest sessions",
      ...
      usageCacheWrite: "Cache write",
      usageReasoning: "Reasoning",
      usageTurnCount_one: "{{count}} turn",
      usageTurnCount_other: "{{count}} turns",
      usageEmpty: "No completed usage in this range.",
      diagnosticsStatus: "Runtime status",
      diagnosticsDesc: "Inspect host, workspace, and recoverable incidents.",
      diagnosticsUnavailable: "Diagnostics are unavailable while the host is offline.",
      hostStatus: "Host status",
      hostStatusDesc: "Rust host and local runtime availability.",
      healthy: "Healthy",
      ...
      unknown: "Unknown",
      capabilitiesStatus: "Capabilities",
      capabilitiesDesc: "Available core capabilities.",
      incidents: "Active incidents",
      incidentsDesc: "Bounded diagnostic conditions recorded in this process.",
      recentIncidents: "Recent incidents",
      noRecoveryAction: "Review the logs for more detail.",
      supportBundle: "Support diagnostics",
      supportBundleTitle: "Export a support bundle",
      supportBundleDesc: "Writes redacted runtime diagnostics. Prompts, files, secrets, and plugin contents are excluded.",
      exportSupportBundle: "Export JSON",
      supportBundleExported: "Support diagnostics exported",
    general: "General",
    scenicThemes: "Scenic themes",
    ...
    scenicApply: "Apply",
    workspaces: "Workspaces",
    workspacesDesc: "Nexus-managed local Git worktrees only.",
    workspacesEmpty: "No managed worktrees.",
    workspacesEmptyTitle: "No managed worktrees yet",
    workspacesEmptyBody: "Open a project to create an isolated workspace when a task needs one.",
    workspaceOpenProject: "Open a project",
    workspaceDirectFolder: "Work directly in this folder",
    workspaceOpen: "Open task",
    workspaceReveal: "Reveal",
    workspaceCleanup: "Clean up",
    workspaceMissing: "Folder unavailable",
    workspaceDirty: "Uncommitted changes",
    workspaceMerged: "Clean and merged",
    workspaceActive: "Active branch",
    workspaceTasks_one: "{{count}} task",
    workspaceTasks_other: "{{count}} tasks",
    refresh: "Refresh",
    ai: "AI",
    shortcuts: "Shortcuts",
    instructions: "Instructions",
    ...
    nexusWorkflowSkills: "Nexus workflow skills",
    nexusWorkflowSkillsPath: "Nexus application resources",
    nexusSkillVersion: "Nexus · v{{version}}",
    nexusSkillReadOnly: "Bundled by Nexus. Read-only.",
    inspectNexusSkill: "Inspect {{name}}",
    mcp: "MCP servers",
    ...
    themeDesc: "Choose system, light, dark, or a scenic theme.",
    themeSystem: "System",
    themeLight: "Light",
    themeDark: "Dark",
    themeTwilightMountains: "Twilight Mountains",
    themeAlpineLight: "Alpine Light",
    ...
    twilightBackdropBlurLow: "Low",
    twilightBackdropBlurMedium: "Medium",
    twilightBackdropBlurHigh: "High",
  ...
  project: {
    ...
    workbenchLocalChanges: "Local changes",
    workbenchContracts: "Plan and Goal contracts",
    workbenchClean: "Clean",
    workbenchChanged: "Changed",
    workbenchActivateToInspect: "Activate to inspect",
    workbenchActivateHint: "Activate this project to inspect its current Git worktree.",
    workbenchDiffUnavailable: "Could not read the current worktree.",
    workbenchFiles: "changed files",
    workbenchTruncated: "Truncated",
    workbenchNoChanges: "No current local changes.",
    workbenchNoContracts: "No Plan or Goal contracts are associated with this project.",
    workbenchEvidenceHint: "Contract state and local changes are evidence surfaces; they do not mark a Goal complete automatically.",
  ...
  contextVault: {
    ...
    allEntries: "All entries", categoriesLabel: "Categories", tags: "Tags", tagsPlaceholder: "api, workflow",
    ...
    addFirst: "Add your first claim", purposeArchitecture: "Architecture", purposeDecisions: "Decisions", purposeGotchas: "Gotchas",
    ...
    evidence: "Evidence", addEvidence: "Add evidence", removeEvidence: "Remove evidence", evidenceHint: "Repository claims need exact, current workspace evidence.",
    userDecisionHint: "User decisions are kept without repository evidence and remain unverified.",
    relationship: "Relationships", addRelationship: "Add relationship", removeRelationship: "Remove relationship", relationshipType: "Type", relationshipTarget: "Target", relatedTo: "Related to", supersedes: "Supersedes", none: "None",
    reviewLabel: "Review", reviewState: "State", reviewNote: "Review note", applyReview: "Apply review", editClaim: "Edit claim", closeEditor: "Close editor",
    save: "Save", saving: "Saving…", saved: "Claim saved", saveResult: "Existing claim: {{status}}", cancel: "Cancel", recheck: "Re-check evidence", rechecked: "Evidence re-checked", reviewed: "Review updated", markReviewed: "Mark reviewed", delete: "Delete", deleted: "Claim deleted",
    deleteTitle: "Delete this claim?", deleteBody: "This permanently removes the selected claim from this project.",
    exported: "Knowledge pack exported", importPreview: "Review import", importPreviewBody: "Choose the valid claims to add to this project. Existing claims are never overwritten.", closeImport: "Close import preview", importSelected: "Import {{count}} selected", imported: "Imported {{imported}} · skipped {{skipped}}", invalidClaim: "Invalid claim",
    claimList: "Vault claims", noMatchingClaims: "No matching claims", importStatus: { selectable: "Ready to import", duplicate: "Already in this vault", overlap: "Possible overlap", invalid: "Invalid", incompatible: "Incompatible" },
