...
export const zhTW = {
  ...
  chat: {
    ...
    permissionFullAccessTerminal: "終端機：不必每次詢問即可執行命令。",
    permissionFullAccessInternet: "網際網路與連線工具：傳送要求或使用已啟用的整合。",
    permissionFullAccessSensitiveData: "敏感資料：內容可能暴露給工具或服務。",
    permissionFullAccessPromptInjection: "提示注入：不受信任的內容可能嘗試影響代理。",
    permissionFullAccessConfirm: "啟用完整存取",
    modePlan: "規劃",
    modeGoal: "目標",
    modeAgent: "智慧體",
    thinking: "思考",
  ...
  settings: {
    ...
    nexusWorkflowSkills: "Nexus 工作流程技能",
    nexusWorkflowSkillsPath: "Nexus 應用程式資源",
    nexusSkillVersion: "Nexus · v{{version}}",
    nexusSkillReadOnly: "由 Nexus 隨附。唯讀。",
    inspectNexusSkill: "檢視 {{name}}",
    mcp: "MCP 伺服器",
    ...
    themeLightDesc: "淺色主題。",
    themeDarkDesc: "深色主題。",
    themeTwilightMountainsDesc: "深色山景玻璃主題。",
    ...
    scenicApply: "套用",
    workspaces: "工作區",
    workspacesDesc: "僅顯示 Nexus 管理的本機 Git 工作樹。",
    workspacesEmpty: "沒有受管理的工作樹。",
    workspacesEmptyTitle: "還沒有受管理的工作樹",
    workspacesEmptyBody: "開啟一個專案；需要時，Nexus 會為工作建立隔離工作區。",
    workspaceOpenProject: "開啟專案",
    workspaceDirectFolder: "直接在此資料夾工作",
    workspaceOpen: "開啟工作",
    workspaceReveal: "在資料夾中顯示",
    workspaceCleanup: "清理",
    workspaceMissing: "資料夾無法使用",
    workspaceDirty: "有未提交的變更",
    workspaceMerged: "乾淨且已合併",
    workspaceActive: "使用中的分支",
    workspaceTasks_one: "{{count}} 個工作",
    workspaceTasks_other: "{{count}} 個工作",
    refresh: "重新整理",
    ...
    fontSizeSaveError: "無法儲存字型大小。",
     ...
     usagePricing: "Usage & Pricing",
     tokens: "Token",
     usageDescription: "檢視 Nexus 本機主機記錄的已完成回合 Token 用量。",
     usageEyebrow: "Nexus 遙測",
     usageHeadline: "用量概覽",
     usageTokensInRange: "所選範圍內",
     usageCompleted: "已完成",
     usageProviderInput: "服務輸入",
     usageProviderOutput: "服務輸出",
     usageActivity: "活動",
     usageActivityHint: "依週期顯示 Token 量",
     usageLatest: "最近週期",
     usageLatestHint: "最近完成的週期",
     usageRange: "用量範圍",
     usageDaily: "每日",
     usageWeekly: "每週",
     usageMonthly: "每月",
     usageUnavailable: "無法取得用量歷史。",
     usageTotal: "Token 總數",
     usageInput: "輸入 Token",
     usageOutput: "輸出 Token",
     usageTurns: "已完成回合",
     usageHistory: "用量歷史",
    usageBreakdown: "Token 明細",
     usageMix: "Token 組成",
     usageMixHint: "已完成回合用量占比",
     usageRhythm: "節奏",
     usageRhythmHint: "按期間的 Token 用量",
     usagePeriods: "期間",
     usagePeriodsTitle: "最近期間",
     usagePeriodsHint: "已完成回合活動",
     usageTurnsShort: "回合",
     usageTurnsTitle: "已完成回合",
     usageTurnsHint: "主機累計記錄",
     usageAverage: "每回合平均",
     ...
     usageStreak: "連續 {{current}} 天",
     usageLongest: "最長 {{longest}}",
     usageMilestoneReached: "於 {{date}} 達到 {{value}}",
     usageBestDay: "目前最忙的一天是 {{date}}，用了 {{tokens}} 個 Token。你通常在 {{hour}} 思考最集中。",
     usageNextMilestone: "下一個里程碑 {{value}}",
     usageMilestoneRemaining: "還差 {{value}}",
     usageFilters: "用量篩選",
     usageAllTools: "所有工具",
     usageAllModels: "所有模型",
     usageAllProviders: "所有提供者",
     usageFilterPlaceholder: "按模型、提供者、工具或工作階段篩選",
     usageClearFilters: "清除篩選",
     usageModelsTitle: "模型",
     usageModelsHint: "此期間的模型",
     usageToolsTitle: "工具",
     usageToolsHint: "此期間的來源",
     usageSessionsTitle: "最活躍工作階段",
     ...
     usageCacheWrite: "快取寫入",
     usageReasoning: "推理",
     usageTurnCount_one: "{{count}} 個回合",
     usageTurnCount_other: "{{count}} 個回合",
     usageEmpty: "此範圍內沒有已完成用量。",
     diagnosticsStatus: "執行狀態",
     diagnosticsDesc: "檢查主機、工作區和可復原事件。",
     diagnosticsUnavailable: "主機離線時無法使用診斷。",
     hostStatus: "主機狀態",
     hostStatusDesc: "Rust 主機和本機執行階段可用性。",
     healthy: "正常",
     unhealthy: "無法使用",
     ...
     needsAttention: "需要注意",
     unknown: "未知",
     capabilitiesStatus: "功能",
     capabilitiesDesc: "可用的核心功能。",
     incidents: "作用中事件",
     incidentsDesc: "此程序記錄的有限診斷狀態。",
     recentIncidents: "最近事件",
     noRecoveryAction: "請查看日誌以取得詳細資訊。",
     supportBundle: "支援診斷",
     supportBundleTitle: "匯出支援套件",
     supportBundleDesc: "匯出已遮罩的執行階段診斷，不包含提示、檔案、密鑰或外掛程式內容。",
     exportSupportBundle: "匯出 JSON",
     supportBundleExported: "支援診斷已匯出",
     bottomPanel: "底部面板",
  ...
  project: {
    ...
    sessionsCount_other: "{{count}} 個會話",
     noSessions: "此專案暫無會話",
     workbenchLocalChanges: "本機變更",
     workbenchContracts: "計畫與目標契約",
     workbenchClean: "乾淨",
     workbenchChanged: "已變更",
     workbenchActivateToInspect: "啟用後檢視",
     workbenchActivateHint: "啟用此專案以檢視目前的 Git 工作區。",
     workbenchDiffUnavailable: "無法讀取目前工作區。",
     workbenchFiles: "個變更檔案",
     workbenchTruncated: "已截斷",
     workbenchNoChanges: "目前沒有本機變更。",
     workbenchNoContracts: "此專案沒有相關的計畫或目標契約。",
     workbenchEvidenceHint: "契約狀態與本機變更是證據檢視，不會自動將目標標記為完成。",
