...
export const ko = {
  ...
  chat: {
    ...
    usageContextAria: "컨텍스트 {{percent}}% 남음, 토큰 {{remaining}}개",
    usageTurnTotal: "이번 턴",
    ...
    permissionFullAccessTerminal: "터미널: 매번 묻지 않고 명령을 실행합니다.",
    permissionFullAccessInternet: "인터넷 및 연결된 도구: 요청을 보내거나 활성화된 통합을 사용합니다.",
    permissionFullAccessSensitiveData: "민감한 데이터: 콘텐츠가 도구 또는 서비스에 노출될 수 있습니다.",
    permissionFullAccessPromptInjection: "프롬프트 인젝션: 신뢰할 수 없는 콘텐츠가 에이전트에 영향을 주려 할 수 있습니다.",
    permissionFullAccessConfirm: "전체 액세스 사용",
    modePlan: "계획",
    modeGoal: "목표",
    modeAgent: "에이전트",
    thinking: "생각 중",
  ...
  settings: {
    ...
    nexusWorkflowSkills: "Nexus 워크플로 스킬",
    nexusWorkflowSkillsPath: "Nexus 애플리케이션 리소스",
    nexusSkillVersion: "Nexus · v{{version}}",
    nexusSkillReadOnly: "Nexus에 포함됨. 읽기 전용입니다.",
    inspectNexusSkill: "{{name}} 검사",
    mcp: "MCP 서버",
    ...
    themeDesc: "시스템, 밝게, 어둡게 또는 산 풍경 테마를 선택합니다.",
    themeSystem: "시스템",
    themeLight: "밝게",
    themeDark: "어둡게",
    themeTwilightMountains: "황혼의 산맥",
    themeAlpineLight: "Alpine Light",
    themeSystemDesc: "시스템 설정을 따릅니다.",
    themeLightDesc: "밝은 테마입니다.",
    themeDarkDesc: "어두운 테마입니다.",
    themeTwilightMountainsDesc: "어두운 산 풍경 유리 테마입니다.",
    ...
    scenicApply: "적용",
    workspaces: "작업 공간",
    workspacesDesc: "Nexus가 관리하는 로컬 Git 작업 트리만 표시합니다.",
    workspacesEmpty: "관리되는 작업 트리가 없습니다.",
    workspacesEmptyTitle: "아직 관리되는 작업 트리가 없습니다",
    workspacesEmptyBody: "프로젝트를 열면 작업에 격리가 필요할 때 Nexus가 여기에 격리된 작업 공간을 만듭니다.",
    workspaceOpenProject: "프로젝트 열기",
    workspaceDirectFolder: "이 폴더에서 직접 작업",
    workspaceOpen: "작업 열기",
    workspaceReveal: "폴더에서 보기",
    workspaceCleanup: "정리",
    workspaceMissing: "폴더를 사용할 수 없음",
    workspaceDirty: "커밋되지 않은 변경 사항",
    workspaceMerged: "깨끗하고 병합됨",
    workspaceActive: "활성 브랜치",
    workspaceTasks_one: "작업 {{count}}개",
    workspaceTasks_other: "작업 {{count}}개",
    refresh: "새로 고침",
    ...
    fontSizeSaveError: "글꼴 크기를 저장할 수 없습니다.",
     ...
     usagePricing: "Usage & Pricing",
     tokens: "토큰",
     usageDescription: "Nexus 로컬 호스트가 기록한 완료된 턴의 토큰 사용량을 확인합니다.",
     usageEyebrow: "Nexus 텔레메트리",
     usageHeadline: "한눈에 보는 사용량",
     usageTokensInRange: "선택한 범위",
     usageCompleted: "완료됨",
     usageProviderInput: "프로바이더 입력",
     usageProviderOutput: "프로바이더 출력",
     usageActivity: "활동",
     usageActivityHint: "기간별 토큰 양",
     usageLatest: "최근 기간",
     usageLatestHint: "최근 완료된 기간",
     usageRange: "사용량 범위",
     usageDaily: "일간",
     usageWeekly: "주간",
     usageMonthly: "월간",
     usageUnavailable: "사용량 기록을 사용할 수 없습니다.",
     usageTotal: "총 토큰",
     usageInput: "입력 토큰",
     usageOutput: "출력 토큰",
     usageTurns: "완료된 턴",
     usageHistory: "사용량 기록",
     usageBreakdown: "토큰 분석",
     usageMix: "토큰 구성",
     usageMixHint: "완료된 턴 볼륨 비율",
     usageRhythm: "리듬",
     usageRhythmHint: "기간별 토큰 볼륨",
     usagePeriods: "기간",
     usagePeriodsTitle: "최근 기간",
     usagePeriodsHint: "완료된 턴 활동",
     usageTurnsShort: "턴",
     usageTurnsTitle: "완료된 턴",
     usageTurnsHint: "호스트 누적 기록",
     usageAverage: "턴당 평균",
     ...
     usageStreak: "{{current}}일 연속",
     usageLongest: "최장 {{longest}}",
     usageMilestoneReached: "{{date}}에 {{value}} 달성",
     usageBestDay: "최고의 날은 {{date}}로 {{tokens}} 토큰이었습니다. 가장 활발한 시간은 {{hour}}입니다.",
     usageNextMilestone: "다음 목표 {{value}}",
     usageMilestoneRemaining: "{{value}} 남음",
     usageFilters: "사용량 필터",
     usageAllTools: "모든 도구",
     usageAllModels: "모든 모델",
     usageAllProviders: "모든 제공자",
     usageFilterPlaceholder: "모델, 제공자, 도구 또는 세션으로 필터링",
     usageClearFilters: "필터 지우기",
     usageModelsTitle: "모델",
     usageModelsHint: "이 기간의 모델",
     usageToolsTitle: "도구",
     usageToolsHint: "이 기간의 소스",
     usageSessionsTitle: "가장 바쁜 세션",
     ...
     usageCacheWrite: "캐시 쓰기",
     usageReasoning: "추론",
     usageTurnCount_one: "{{count}}턴",
     usageTurnCount_other: "{{count}}턴",
     usageEmpty: "이 범위에 완료된 사용량이 없습니다.",
     diagnosticsStatus: "런타임 상태",
     diagnosticsDesc: "호스트, 작업 공간 및 복구 가능한 문제를 확인합니다.",
     diagnosticsUnavailable: "호스트가 오프라인이면 진단을 사용할 수 없습니다.",
     hostStatus: "호스트 상태",
     hostStatusDesc: "Rust 호스트 및 로컬 런타임 가용성입니다.",
     healthy: "정상",
     unhealthy: "사용할 수 없음",
     workspaceStatus: "작업 공간 상태",
     ready: "준비됨",
     needsAttention: "확인 필요",
     unknown: "알 수 없음",
     capabilitiesStatus: "기능",
     capabilitiesDesc: "사용 가능한 핵심 기능입니다.",
     incidents: "활성 문제",
     incidentsDesc: "이 프로세스에서 기록된 제한된 진단 상태입니다.",
     recentIncidents: "최근 문제",
     noRecoveryAction: "자세한 내용은 로그를 확인하세요.",
     supportBundle: "지원 진단",
     supportBundleTitle: "지원 패키지 내보내기",
     supportBundleDesc: "프롬프트, 파일, 비밀 정보 및 플러그인 콘텐츠를 제외한 진단을 내보냅니다.",
     exportSupportBundle: "JSON 내보내기",
     supportBundleExported: "지원 진단을 내보냈습니다",
     bottomPanel: "하단 패널",
  ...
  project: {
    ...
    sessionsCount_other: "세션 {{count}}개",
     ...
     workbenchLocalChanges: "로컬 변경 사항",
     workbenchContracts: "계획 및 목표 계약",
     workbenchClean: "깨끗함",
     workbenchChanged: "변경됨",
     workbenchActivateToInspect: "활성화하여 검사",
     workbenchActivateHint: "현재 Git 작업 트리를 검사하려면 이 프로젝트를 활성화하세요.",
     workbenchDiffUnavailable: "현재 작업 트리를 읽을 수 없습니다.",
     workbenchFiles: "변경된 파일",
     workbenchTruncated: "잘림",
     workbenchNoChanges: "현재 로컬 변경 사항이 없습니다.",
     workbenchNoContracts: "이 프로젝트에 연결된 계획 또는 목표 계약이 없습니다.",
     workbenchEvidenceHint: "계약 상태와 로컬 변경 사항은 증거 화면이며 목표를 자동으로 완료하지 않습니다.",
