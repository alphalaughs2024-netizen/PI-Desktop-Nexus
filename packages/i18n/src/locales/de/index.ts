...
const contextVaultFallback: EnglishCatalog["contextVault"] = {
  noProject: "Open a project to use its private vault.", health: "{{reviewed}} reviewed architecture · {{decisions}} user decisions · {{stale}} possibly stale",
  newClaim: "New claim", userDecision: "User decision", export: "Export", import: "Import", allEntries: "All entries", categoriesLabel: "Categories", tags: "Tags", tagsPlaceholder: "api, workflow",
  search: "Search durable project knowledge", emptyTitle: "No durable knowledge yet", emptyBody: "Claims stay private to this project. Save only decisions and facts worth reusing.", addFirst: "Add your first claim", purposeArchitecture: "Architecture", purposeDecisions: "Decisions", purposeGotchas: "Gotchas",
  claim: "Claim", category: "Category", impact: "Impact", scope: "Scope", recheckGuidance: "Re-check guidance", evidencePath: "Evidence path", evidenceExcerpt: "Literal evidence excerpt", evidence: "Evidence", addEvidence: "Add evidence", removeEvidence: "Remove evidence", evidenceHint: "Repository claims need exact, current workspace evidence.", userDecisionHint: "User decisions are kept without repository evidence and remain unverified.",
  relationship: "Relationships", addRelationship: "Add relationship", removeRelationship: "Remove relationship", relationshipType: "Type", relationshipTarget: "Target", relatedTo: "Related to", supersedes: "Supersedes", none: "None", reviewLabel: "Review", reviewState: "State", reviewNote: "Review note", applyReview: "Apply review", editClaim: "Edit claim", closeEditor: "Close editor",
  save: "Save", saving: "Saving…", saved: "Claim saved", saveResult: "Existing claim: {{status}}", cancel: "Cancel", recheck: "Re-check evidence", rechecked: "Evidence re-checked", reviewed: "Review updated", markReviewed: "Mark reviewed", delete: "Delete", deleted: "Claim deleted", deleteTitle: "Delete this claim?", deleteBody: "This permanently removes the selected claim from this project.",
  exported: "Knowledge pack exported", importPreview: "Review import", importPreviewBody: "Choose the valid claims to add to this project. Existing claims are never overwritten.", closeImport: "Close import preview", importSelected: "Import {{count}} selected", imported: "Imported {{imported}} · skipped {{skipped}}", invalidClaim: "Invalid claim", claimList: "Vault claims", noMatchingClaims: "No matching claims", importStatus: { selectable: "Ready to import", duplicate: "Already in this vault", overlap: "Possible overlap", invalid: "Invalid", incompatible: "Incompatible" },
  categories: { architecture: "Architecture", decisions: "Decisions", conventions: "Conventions", gotchas: "Gotchas", notes: "Notes" }, freshness: { fresh: "Fresh", possibly_stale: "Possibly stale", stale: "Stale", unavailable: "Unavailable", unverified: "Unverified" }, review: { reviewed: "Reviewed", conflicted: "Conflicted", superseded: "Superseded", pending: "Pending" },
};
...
export const de = {
  ...
  "chat": {
    ...
    "usageContextAria": "{{percent}}% Kontext verbleibend, {{remaining}} Token übrig",
    ...
    "permissionFullAccessTerminal": "Terminal: Befehle ausführen, ohne jedes Mal zu fragen.",
    "permissionFullAccessInternet": "Internet und verbundene Werkzeuge: Anfragen senden oder aktivierte Integrationen verwenden.",
    "permissionFullAccessSensitiveData": "Sensible Daten: Inhalte können Werkzeugen oder Diensten offengelegt werden.",
    "permissionFullAccessPromptInjection": "Prompt-Injection: Nicht vertrauenswürdige Inhalte können versuchen, den Agenten zu beeinflussen.",
    "permissionFullAccessConfirm": "Vollzugriff aktivieren",
    "modePlan": "Plan",
    "modeGoal": "Ziel",
    "modeAgent": "Agent",
    "thinking": "Denken",
  ...
  "settings": {
    ...
    "delete": "Löschen",
    "theme": "Design",
    "themeFromPlugin": "Design aus Plugin",
    "mode": "Standardmodus",
    "back": "Zurück",
    ...
    "workspaces": "Arbeitsbereiche",
    "workspacesDesc": "Nur von Nexus verwaltete lokale Git-Arbeitsbäume.",
    "workspacesEmpty": "Keine verwalteten Arbeitsbäume.",
    "workspacesEmptyTitle": "Noch keine verwalteten Arbeitsbäume",
    "workspacesEmptyBody": "Öffne ein Projekt. Wenn eine Aufgabe Isolation braucht, erstellt Nexus hier einen Arbeitsbereich.",
    "workspaceOpenProject": "Projekt öffnen",
    "workspaceDirectFolder": "Direkt in diesem Ordner arbeiten",
    "workspaceOpen": "Aufgabe öffnen",
    "workspaceReveal": "Anzeigen",
    "workspaceCleanup": "Bereinigen",
    "workspaceMissing": "Ordner nicht verfügbar",
    "workspaceDirty": "Nicht übernommene Änderungen",
    "workspaceMerged": "Sauber und zusammengeführt",
    "workspaceActive": "Aktiver Branch",
    "workspaceTasks_one": "{{count}} Aufgabe",
    "workspaceTasks_other": "{{count}} Aufgaben",
    ...
    "nexusWorkflowSkills": "Nexus-Workflow-Fähigkeiten",
    "nexusWorkflowSkillsPath": "Nexus-Anwendungsressourcen",
    "nexusSkillVersion": "Nexus · v{{version}}",
    "nexusSkillReadOnly": "Von Nexus gebündelt. Schreibgeschützt.",
    "inspectNexusSkill": "{{name}} ansehen",
    "mcp": "MCP-Server",
    ...
    "themeDesc": "System, hell, dunkel oder ein Landschaftsthema wählen.",
    "themeSystem": "System",
    "themeLight": "Hell",
    "themeDark": "Dunkel",
    "themeTwilightMountains": "Dämmerungsberge",
    "themeAlpineLight": "Alpenlicht",
    "themeSystemDesc": "Systemeinstellung befolgen.",
    "themeLightDesc": "Lichtthema.",
    "themeDarkDesc": "Dunkles Thema.",
    "themeTwilightMountainsDesc": "Dunkles, landschaftliches Glasthema.",
    ...
    "fontSizeSaveError": "Die Schriftgröße konnte nicht gespeichert werden.",
     ...
     "usageHeadline": "Nutzung auf einen Blick",
     "usageTokensInRange": "im gewählten Bereich",
     "usageCompleted": "abgeschlossen",
     "usageProviderInput": "Provider-Eingabe",
     "usageProviderOutput": "Provider-Ausgabe",
     "usageActivity": "Aktivität",
     "usageActivityHint": "Tokenvolumen nach Zeitraum",
     "usageLatest": "Letzter Zeitraum",
     "usageLatestHint": "Letzter abgeschlossener Zeitraum",
     "usageRange": "Nutzungsbereich",
     "usageDaily": "Täglich",
     "usageWeekly": "Wöchentlich",
     "usageMonthly": "Monatlich",
     "usageUnavailable": "Nutzungsverlauf ist nicht verfügbar.",
     "usageTotal": "Token gesamt",
     "usageInput": "Eingabe-Token",
     "usageOutput": "Ausgabe-Token",
     "usageTurns": "Abgeschlossene Läufe",
     "usageHistory": "Nutzungsverlauf",
     "usageBreakdown": "Token-Aufschlüsselung",
     "usageCacheRead": "Cache-Lesen",
     "usageCacheWrite": "Cache-Schreiben",
     "usageReasoning": "Schlussfolgerung",
     "usageTurnCount_one": "{{count}} Lauf",
     "usageTurnCount_other": "{{count}} Läufe",
     "usageEmpty": "Keine abgeschlossene Nutzung in diesem Bereich.",
     "usageMix": "Token-Mix",
     "usageMixHint": "Anteil des Volumens abgeschlossener Runden",
     "usageRhythm": "Rhythmus",
     "usageRhythmHint": "Token-Volumen pro Zeitraum",
     "usagePeriods": "Zeiträume",
     "usagePeriodsTitle": "Letzte Zeiträume",
     "usagePeriodsHint": "Aktivität abgeschlossener Runden",
     "usageTurnsShort": "Runden",
     "usageTurnsTitle": "Abgeschlossene Runden",
     "usageTurnsHint": "Dauerhafte Host-Aufzeichnung",
     ...
     "usageStreak": "{{current}}-Tage-Serie",
     "usageLongest": "Längste {{longest}}",
     "usageMilestoneReached": "{{value}} erreicht am {{date}}",
     "usageBestDay": "Dein bester Tag war {{date}} mit {{tokens}} Tokens. Am intensivsten denkst du gegen {{hour}}.",
     "usageNextMilestone": "Nächster Meilenstein {{value}}",
     "usageMilestoneRemaining": "Noch {{value}}",
     "usageFilters": "Nutzungsfilter",
     "usageAllTools": "Alle Tools",
     "usageAllModels": "Alle Modelle",
     "usageAllProviders": "Alle Anbieter",
     "usageFilterPlaceholder": "Nach Modell, Anbieter, Tool oder Sitzung filtern",
     "usageClearFilters": "Filter löschen",
     "usageModelsTitle": "Modelle",
     "usageModelsHint": "Modelle in diesem Zeitraum",
     "usageToolsTitle": "Tools",
     "usageToolsHint": "Quellen in diesem Zeitraum",
     "usageSessionsTitle": "Aktivste Sitzungen",
  ...
  "project": {
    ...
    "sessionsCount_other": "{{count}} Sitzungen",
     ...
     "workbenchLocalChanges": "Lokale Änderungen",
     "workbenchContracts": "Plan- und Zielverträge",
     "workbenchClean": "Sauber",
     "workbenchChanged": "Geändert",
     "workbenchActivateToInspect": "Zum Prüfen aktivieren",
     "workbenchActivateHint": "Aktivieren Sie dieses Projekt, um den aktuellen Git-Arbeitsbaum zu prüfen.",
     "workbenchDiffUnavailable": "Der aktuelle Arbeitsbaum konnte nicht gelesen werden.",
     "workbenchFiles": "geänderte Dateien",
     "workbenchTruncated": "Gekürzt",
     "workbenchNoChanges": "Keine lokalen Änderungen.",
     "workbenchNoContracts": "Keine Plan- oder Zielverträge für dieses Projekt.",
     "workbenchEvidenceHint": "Vertragsstatus und lokale Änderungen sind Evidenzflächen; ein Ziel wird nicht automatisch abgeschlossen.",
  ...
  "panel": {
    ...
    "tabs": {
      ...
      "contextVault": "Kontextspeicher",`r`n      "promptInspector": "Prompt-Kontext"`r`n    },
    "pluginView": {
