...
export const tr = {
  ...
  chat: {
    ...
    permissionFullAccessTerminal: "Terminal: Her seferinde sormadan komut çalıştırabilir.",
    permissionFullAccessInternet: "İnternet ve bağlı araçlar: İstek gönderebilir veya etkin entegrasyonları kullanabilir.",
    permissionFullAccessSensitiveData: "Hassas veriler: İçerik araçlara veya hizmetlere açılabilir.",
    permissionFullAccessPromptInjection: "İstem enjeksiyonu: Güvenilmeyen içerik aracıyı etkilemeye çalışabilir.",
    permissionFullAccessConfirm: "Tam erişimi etkinleştir",
    modePlan: "Plan",
    modeGoal: "Hedef",
    modeAgent: "Ajan",
    thinking: "Düşünme",
  ...
  settings: {
    ...
    delete: "Sil",
    theme: "Tema",
    themeFromPlugin: "Eklenti teması",
    mode: "Varsayılan kip",
    back: "Geri",
    ...
    nexusWorkflowSkills: "Nexus iş akışı becerileri",
    nexusWorkflowSkillsPath: "Nexus uygulama kaynakları",
    nexusSkillVersion: "Nexus · v{{version}}",
    nexusSkillReadOnly: "Nexus ile birlikte gelir. Salt okunur.",
    inspectNexusSkill: "{{name}} incele",
    mcp: "MCP sunucuları",
    ...
    themeDesc: "Sistem, açık, koyu veya manzaralı bir tema seçin.",
    themeSystem: "Sistem",
    themeLight: "Hafif",
    themeDark: "Koyu",
    themeTwilightMountains: "Alacakaranlık Dağları",
    themeAlpineLight: "Alpine Light",
    themeSystemDesc: "Sistem ayarını izle.",
    themeLightDesc: "Açık tema.",
    themeDarkDesc: "Koyu tema.",
    themeTwilightMountainsDesc: "Koyu, manzaralı cam tema.",
    ...
    scenicApply: "Uygula",
    workspaces: "Çalışma alanları",
    workspacesDesc: "Yalnızca Nexus tarafından yönetilen yerel Git çalışma ağaçları.",
    workspacesEmpty: "Yönetilen çalışma ağacı yok.",
    workspacesEmptyTitle: "Henüz yönetilen çalışma ağacı yok",
    workspacesEmptyBody: "Bir proje açın; bir görev ihtiyaç duyduğunda Nexus yalıtılmış bir çalışma alanı oluşturur.",
    workspaceOpenProject: "Proje aç",
    workspaceDirectFolder: "Bu klasörde doğrudan çalış",
    workspaceOpen: "Görevi aç",
    workspaceReveal: "Göster",
    workspaceCleanup: "Temizle",
    workspaceMissing: "Klasör kullanılamıyor",
    workspaceDirty: "İşlenmemiş değişiklikler",
    workspaceMerged: "Temiz ve birleştirildi",
    workspaceActive: "Etkin dal",
    workspaceTasks_one: "{{count}} görev",
    workspaceTasks_other: "{{count}} görev",
    refresh: "Yenile",
    ...
    fontSizeSaveError: "Yazı boyutu kaydedilemedi.",
     ...
     usagePricing: "Usage & Pricing",
     tokens: "Token",
     usageDescription: "Nexus yerel ana bilgisayarındaki tamamlanan turların token kullanımını inceleyin.",
     usageEyebrow: "Nexus telemetrisi",
     usageHeadline: "Kullanıma genel bakış",
     usageTokensInRange: "seçili aralıkta",
     usageCompleted: "tamamlandı",
     usageProviderInput: "sağlayıcı girdisi",
     usageProviderOutput: "sağlayıcı çıktısı",
     usageActivity: "Etkinlik",
     usageActivityHint: "Döneme göre token hacmi",
     usageLatest: "Son dönem",
     usageLatestHint: "En son tamamlanan dönem",
     usageRange: "Kullanım aralığı",
     usageDaily: "Günlük",
     usageWeekly: "Haftalık",
     usageMonthly: "Aylık",
     usageUnavailable: "Kullanım geçmişi kullanılamıyor.",
     usageTotal: "Toplam token",
     usageInput: "Girdi tokenları",
     usageOutput: "Çıktı tokenları",
     usageTurns: "Tamamlanan turlar",
     usageHistory: "Kullanım geçmişi",
    usageBreakdown: "Token dökümü",
     usageMix: "Token dağılımı",
     usageMixHint: "Tamamlanan tur hacminin payı",
     usageRhythm: "Ritim",
     usageRhythmHint: "Döneme göre token hacmi",
     usagePeriods: "dönem",
     usagePeriodsTitle: "Son dönemler",
     usagePeriodsHint: "Tamamlanan tur etkinliği",
     usageTurnsShort: "tur",
     usageTurnsTitle: "Tamamlanan turlar",
     usageTurnsHint: "Kalıcı ana makine toplamı",
     ...
     usageStreak: "{{current}} günlük seri",
     usageLongest: "En uzun {{longest}}",
     usageMilestoneReached: "{{date}} tarihinde {{value}} ulaşıldı",
     usageBestDay: "En iyi günün {{date}} idi: {{tokens}} token. En yoğun düşünme saatin yaklaşık {{hour}}.",
     usageNextMilestone: "Sonraki hedef {{value}}",
     usageMilestoneRemaining: "{{value}} kaldı",
     usageFilters: "Kullanım filtreleri",
     usageAllTools: "Tüm araçlar",
     usageAllModels: "Tüm modeller",
     usageAllProviders: "Tüm sağlayıcılar",
     usageFilterPlaceholder: "Model, sağlayıcı, araç veya oturuma göre filtrele",
     usageClearFilters: "Filtreleri temizle",
     usageModelsTitle: "Modeller",
     usageModelsHint: "Bu aralıktaki modeller",
     usageToolsTitle: "Araçlar",
     usageToolsHint: "Bu aralıktaki kaynaklar",
     usageSessionsTitle: "En yoğun oturumlar",
     ...
     usageCacheWrite: "Önbellek yazma",
     usageReasoning: "Akıl yürütme",
     usageTurnCount_one: "{{count}} tur",
     usageTurnCount_other: "{{count}} tur",
     usageEmpty: "Bu aralıkta tamamlanan kullanım yok.",
     diagnosticsStatus: "Çalışma zamanı durumu",
     diagnosticsDesc: "Ana bilgisayarı, çalışma alanını ve kurtarılabilir olayları inceleyin.",
     diagnosticsUnavailable: "Ana bilgisayar çevrimdışıyken tanılama kullanılamaz.",
     hostStatus: "Ana bilgisayar durumu",
     hostStatusDesc: "Rust ana bilgisayarı ve yerel çalışma zamanı kullanılabilirliği.",
     healthy: "Sağlıklı",
     unhealthy: "Kullanılamıyor",
     workspaceStatus: "Çalışma alanı durumu",
     ready: "Hazır",
     needsAttention: "İnceleme gerekli",
     unknown: "Bilinmiyor",
     capabilitiesStatus: "Yetenekler",
     capabilitiesDesc: "Kullanılabilir temel yetenekler.",
     incidents: "Etkin olaylar",
     incidentsDesc: "Bu işlemde kaydedilen sınırlı tanılama durumları.",
     recentIncidents: "Son olaylar",
     noRecoveryAction: "Ayrıntılar için günlükleri inceleyin.",
     supportBundle: "Destek tanılaması",
     supportBundleTitle: "Destek paketi dışa aktar",
     supportBundleDesc: "İstemleri, dosyaları, gizli bilgileri ve eklenti içeriğini dışarıda bırakarak tanılama aktarır.",
     exportSupportBundle: "JSON dışa aktar",
     supportBundleExported: "Destek tanılaması dışa aktarıldı",
  ...
  project: {
    ...
    sessionsCount_other: "{{count}} oturum",
     ...
     workbenchLocalChanges: "Yerel değişiklikler",
     workbenchContracts: "Plan ve hedef sözleşmeleri",
     workbenchClean: "Temiz",
     workbenchChanged: "Değiştirildi",
     workbenchActivateToInspect: "İncelemek için etkinleştir",
     workbenchActivateHint: "Geçerli Git çalışma ağacını incelemek için bu projeyi etkinleştirin.",
     workbenchDiffUnavailable: "Geçerli çalışma ağacı okunamadı.",
     workbenchFiles: "değişen dosya",
     workbenchTruncated: "Kesildi",
     workbenchNoChanges: "Geçerli yerel değişiklik yok.",
     workbenchNoContracts: "Bu projeyle ilişkili plan veya hedef sözleşmesi yok.",
     workbenchEvidenceHint: "Sözleşme durumu ve yerel değişiklikler kanıt yüzeyleridir; hedefi otomatik olarak tamamlamaz.",
