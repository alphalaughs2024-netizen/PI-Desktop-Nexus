...
export const zhCN = {
  ...
  chat: {
    ...
    permissionFullAccessTerminal: "终端：无需每次询问即可运行命令。",
    permissionFullAccessInternet: "互联网和连接的工具：发送请求或使用已启用的集成。",
    permissionFullAccessSensitiveData: "敏感数据：内容可能会暴露给工具或服务。",
    permissionFullAccessPromptInjection: "提示注入：不可信内容可能尝试影响代理。",
    permissionFullAccessConfirm: "启用完全访问",
    modePlan: "规划",
    modeGoal: "目标",
    modeAgent: "智能体",
    thinking: "思考",
  ...
  settings: {
    ...
    nav: {
      ...
      usagePricing: "Usage & Pricing",
      tokens: "令牌",
      usageDescription: "查看 Nexus 本地主机记录的已完成回合令牌用量。",
      usageEyebrow: "Nexus 遥测",
      usageHeadline: "用量概览",
      usageTokensInRange: "所选范围内",
      usageCompleted: "已完成",
      usageProviderInput: "服务输入",
      usageProviderOutput: "服务输出",
      usageActivity: "活动",
      usageActivityHint: "按周期显示令牌量",
      usageLatest: "最近周期",
      usageLatestHint: "最近完成的周期",
      usageRange: "用量范围",
      usageDaily: "每日",
      usageWeekly: "每周",
      usageMonthly: "每月",
      usageUnavailable: "无法获取用量历史。",
      usageTotal: "令牌总数",
      usageInput: "输入令牌",
      usageOutput: "输出令牌",
      usageTurns: "已完成回合",
      ...
      usageBreakdown: "令牌明细",
      usageMix: "令牌构成",
      usageMixHint: "已完成回合用量占比",
      usageRhythm: "节奏",
      usageRhythmHint: "按周期的令牌用量",
      usagePeriods: "周期",
      usagePeriodsTitle: "最近周期",
      usagePeriodsHint: "已完成回合活动",
      usageTurnsShort: "回合",
      usageTurnsTitle: "已完成回合",
      usageTurnsHint: "宿主累计记录",
      usageAverage: "每回合平均",
      ...
      usageStreak: "连续 {{current}} 天",
      usageLongest: "最长 {{longest}}",
      usageMilestoneReached: "于 {{date}} 达到 {{value}}",
      usageBestDay: "目前最忙的一天是 {{date}}，用了 {{tokens}} 个令牌。你通常在 {{hour}} 思考最集中。",
      usageNextMilestone: "下一个里程碑 {{value}}",
      usageMilestoneRemaining: "还差 {{value}}",
      usageFilters: "用量筛选",
      usageAllTools: "所有工具",
      usageAllModels: "所有模型",
      usageAllProviders: "所有提供商",
      usageFilterPlaceholder: "按模型、提供商、工具或会话筛选",
      usageClearFilters: "清除筛选",
      usageModelsTitle: "模型",
      usageModelsHint: "此时间范围内的模型",
      usageToolsTitle: "工具",
      usageToolsHint: "此时间范围内的来源",
      usageSessionsTitle: "最活跃会话",
      ...
      usageCacheWrite: "缓存写入",
      usageReasoning: "推理",
      usageTurnCount_one: "{{count}} 个回合",
      usageTurnCount_other: "{{count}} 个回合",
      usageEmpty: "此范围内没有已完成用量。",
      diagnosticsStatus: "运行状态",
      diagnosticsDesc: "查看主机、工作区和可恢复事件。",
      diagnosticsUnavailable: "主机离线时无法使用诊断。",
      hostStatus: "主机状态",
      hostStatusDesc: "Rust 主机和本地运行时可用性。",
      healthy: "正常",
      unhealthy: "不可用",
      ...
      needsAttention: "需要注意",
      unknown: "未知",
      capabilitiesStatus: "能力",
      capabilitiesDesc: "可用的核心能力。",
      incidents: "活动事件",
      incidentsDesc: "此进程记录的有限诊断状态。",
      recentIncidents: "最近事件",
      noRecoveryAction: "查看日志了解详情。",
      supportBundle: "支持诊断",
      supportBundleTitle: "导出支持包",
      supportBundleDesc: "写入已脱敏的运行时诊断，不包含提示词、文件、密钥或插件内容。",
      exportSupportBundle: "导出 JSON",
      supportBundleExported: "支持诊断已导出",
    general: "常规",
    scenicThemes: "场景主题",
    ...
    nexusWorkflowSkills: "Nexus 工作流技能",
    nexusWorkflowSkillsPath: "Nexus 应用资源",
    nexusSkillVersion: "Nexus · v{{version}}",
    nexusSkillReadOnly: "由 Nexus 随附。只读。",
    inspectNexusSkill: "查看 {{name}}",
    mcp: "MCP 服务器",
    ...
    themeDesc: "选择系统、浅色、深色或山景主题。",
    themeSystem: "系统",
    themeLight: "浅色",
    themeDark: "深色",
    themeTwilightMountains: "暮光群山",
    themeAlpineLight: "Alpine Light",
    themeSystemDesc: "跟随系统设置。",
    themeLightDesc: "浅色主题。",
    themeDarkDesc: "深色主题。",
    themeTwilightMountainsDesc: "深色山景玻璃主题。",
    ...
    scenicApply: "应用",
    workspaces: "工作区",
    workspacesDesc: "仅显示 Nexus 管理的本地 Git 工作树。",
    workspacesEmpty: "没有托管工作树。",
    workspacesEmptyTitle: "还没有托管工作树",
    workspacesEmptyBody: "打开一个项目；当任务需要时，Nexus 会为它创建隔离工作区。",
    workspaceOpenProject: "打开项目",
    workspaceDirectFolder: "直接在此文件夹中工作",
    workspaceOpen: "打开任务",
    workspaceReveal: "在文件夹中显示",
    workspaceCleanup: "清理",
    workspaceMissing: "文件夹不可用",
    workspaceDirty: "存在未提交更改",
    workspaceMerged: "干净且已合并",
    workspaceActive: "活动分支",
    workspaceTasks_one: "{{count}} 个任务",
    workspaceTasks_other: "{{count}} 个任务",
    refresh: "刷新",
  ...
  project: {
    ...
    noSessions: "此项目暂无会话",
    workbenchLocalChanges: "本地更改",
    workbenchContracts: "计划与目标契约",
    workbenchClean: "干净",
    workbenchChanged: "有更改",
    workbenchActivateToInspect: "激活后查看",
    workbenchActivateHint: "激活此项目以查看当前 Git 工作区。",
    workbenchDiffUnavailable: "无法读取当前工作区。",
    workbenchFiles: "个更改文件",
    workbenchTruncated: "已截断",
    workbenchNoChanges: "当前没有本地更改。",
    workbenchNoContracts: "此项目没有关联的计划或目标契约。",
    workbenchEvidenceHint: "契约状态和本地更改是证据视图，不会自动将目标标记为完成。",
  ...
  panel: {
    ...
    browser: {
      ...
      reopen: "重新打开浏览器",
      copied: "安全地址已复制。",
      states: { noPage: "浏览器已就绪", starting: "正在启动浏览器…", ready: "浏览器已就绪", loading: "正在加载页面…", unavailable: "浏览器不可用", policyBlocked: "浏览器功能已禁用", debuggerUnavailable: "浏览器调试器不可用", closed: "浏览器已关闭" },
      emptyStates: { unavailableTitle: "浏览器不可用", unavailableBody: "浏览器页面无法启动。", blockedTitle: "浏览器操作被阻止", blockedBody: "当前能力策略不允许此操作。", debuggerTitle: "浏览器连接不可用", debuggerBody: "浏览器暂时无法检查此页面。", closedTitle: "浏览器已关闭", closedBody: "重新打开浏览器后继续。" },
    },
    files: {
  ...
  contextVault: {
    ...
    allEntries: "全部条目", categoriesLabel: "类别", tags: "标签", tagsPlaceholder: "api, workflow",
    search: "搜索持久项目知识", emptyTitle: "还没有持久知识",
    emptyBody: "声明仅属于此项目。只保存值得复用的决策和事实。",
    addFirst: "添加第一条声明", purposeArchitecture: "架构", purposeDecisions: "决策", purposeGotchas: "注意事项",
    claim: "声明", category: "类别", impact: "影响", scope: "范围",
    recheckGuidance: "复查指引", evidencePath: "证据路径", evidenceExcerpt: "原始证据摘录",
    evidence: "证据", addEvidence: "添加证据", removeEvidence: "移除证据", evidenceHint: "仓库声明需要准确且当前的工作区证据。",
    userDecisionHint: "用户决策不包含仓库证据，并保持未验证状态。",
    relationship: "关系", addRelationship: "添加关系", removeRelationship: "移除关系", relationshipType: "类型", relationshipTarget: "目标", relatedTo: "关联", supersedes: "替代", none: "无",
    reviewLabel: "审阅", reviewState: "状态", reviewNote: "审阅说明", applyReview: "应用审阅", editClaim: "编辑声明", closeEditor: "关闭编辑器",
    save: "保存", saving: "正在保存…", saved: "声明已保存", saveResult: "现有声明：{{status}}", cancel: "取消", recheck: "复查证据", rechecked: "证据已复查", reviewed: "审阅已更新", markReviewed: "标记为已审阅", delete: "删除", deleted: "声明已删除",
    deleteTitle: "删除此声明？", deleteBody: "这会从当前项目永久移除所选声明。",
    exported: "知识包已导出", importPreview: "审阅导入", importPreviewBody: "选择要添加到此项目的有效声明。现有声明绝不会被覆盖。", closeImport: "关闭导入预览", importSelected: "导入已选的 {{count}} 条", imported: "已导入 {{imported}} · 已跳过 {{skipped}}", invalidClaim: "无效声明",
    claimList: "知识库声明", noMatchingClaims: "没有匹配的声明", importStatus: { selectable: "可导入", duplicate: "已在此知识库中", overlap: "可能重叠", invalid: "无效", incompatible: "不兼容" },
