...
export const fr = {
  ...
  "chat": {
    ...
    "usageContextAria": "{{percent}}% de contexte restant, {{remaining}} jetons restants",
    ...
    "permissionFullAccessTerminal": "Terminal : exécuter des commandes sans demander à chaque fois.",
    "permissionFullAccessInternet": "Internet et outils connectés : envoyer des requêtes ou utiliser les intégrations activées.",
    "permissionFullAccessSensitiveData": "Données sensibles : le contenu peut être exposé aux outils ou services.",
    "permissionFullAccessPromptInjection": "Injection de prompt : du contenu non fiable peut tenter d’influencer l’agent.",
    "permissionFullAccessConfirm": "Activer l’accès complet",
    "modePlan": "Plan",
    "modeGoal": "Objectif",
    "modeAgent": "Agent",
    "thinking": "Réflexion",
  ...
  "settings": {
    ...
    "delete": "Supprimer",
    "theme": "Thème",
    "themeFromPlugin": "Thème du plugin",
    ...
    "workspaces": "Espaces de travail",
    "workspacesDesc": "Uniquement les arbres de travail Git locaux gérés par Nexus.",
    "workspacesEmpty": "Aucun arbre de travail géré.",
    "workspacesEmptyTitle": "Aucun arbre de travail géré pour le moment",
    "workspacesEmptyBody": "Ouvrez un projet ; Nexus créera ici un espace isolé lorsqu’une tâche en aura besoin.",
    "workspaceOpenProject": "Ouvrir un projet",
    "workspaceDirectFolder": "Travailler directement dans ce dossier",
    "workspaceOpen": "Ouvrir la tâche",
    "workspaceReveal": "Afficher",
    "workspaceCleanup": "Nettoyer",
    "workspaceMissing": "Dossier indisponible",
    "workspaceDirty": "Modifications non validées",
    "workspaceMerged": "Propre et fusionné",
    "workspaceActive": "Branche active",
    "workspaceTasks_one": "{{count}} tâche",
    "workspaceTasks_other": "{{count}} tâches",
    "refresh": "Actualiser",
    "ai": "AI",
    "shortcuts": "Raccourcis",
    "instructions": "Instructions",
    ...
    "nexusWorkflowSkills": "Compétences de flux de travail Nexus",
    "nexusWorkflowSkillsPath": "Ressources de l’application Nexus",
    "nexusSkillVersion": "Nexus · v{{version}}",
    "nexusSkillReadOnly": "Fourni par Nexus. Lecture seule.",
    "inspectNexusSkill": "Inspecter {{name}}",
    "mcp": "Serveurs MCP",
    ...
    "themeDesc": "Choisissez le système, clair, sombre ou un thème panoramique.",
    "themeSystem": "Système",
    "themeLight": "Clair",
    "themeDark": "Foncé",
    "themeTwilightMountains": "Montagnes du crépuscule",
    "themeAlpineLight": "Lumière alpine",
    ...
    "fontSizeSaveError": "Impossible d'enregistrer la taille de la police.",
     ...
     "usageHeadline": "Utilisation en un coup d’œil",
     "usageTokensInRange": "sur la période sélectionnée",
     "usageCompleted": "terminés",
     "usageProviderInput": "entrée du fournisseur",
     "usageProviderOutput": "sortie du fournisseur",
     "usageActivity": "Activité",
     "usageActivityHint": "Volume de tokens par période",
     "usageLatest": "Période récente",
     "usageLatestHint": "Dernière période terminée",
     "usageRange": "Période d’utilisation",
     "usageDaily": "Quotidien",
     "usageWeekly": "Hebdomadaire",
     "usageMonthly": "Mensuel",
     "usageUnavailable": "L’historique d’utilisation est indisponible.",
     "usageTotal": "Tokens totaux",
     "usageInput": "Tokens d’entrée",
     "usageOutput": "Tokens de sortie",
     "usageTurns": "Tours terminés",
     "usageHistory": "Historique d’utilisation",
     "usageBreakdown": "Répartition des tokens",
     "usageCacheRead": "Lecture du cache",
     "usageCacheWrite": "Écriture du cache",
     "usageReasoning": "Raisonnement",
     "usageTurnCount_one": "{{count}} tour",
     "usageTurnCount_other": "{{count}} tours",
     "usageEmpty": "Aucune utilisation terminée sur cette période.",
     "usageMix": "Répartition des tokens",
     "usageMixHint": "Part du volume des tours terminés",
     "usageRhythm": "Rythme",
     "usageRhythmHint": "Volume de tokens par période",
     "usagePeriods": "périodes",
     "usagePeriodsTitle": "Périodes récentes",
     "usagePeriodsHint": "Activité des tours terminés",
     "usageTurnsShort": "tours",
     "usageTurnsTitle": "Tours terminés",
     "usageTurnsHint": "Cumul persistant de l’hôte",
     ...
     "usageStreak": "série de {{current}} jours",
     "usageLongest": "Record {{longest}}",
     "usageMilestoneReached": "{{value}} atteint le {{date}}",
     "usageBestDay": "Votre meilleure journée était le {{date}}, avec {{tokens}} tokens. Votre réflexion est la plus intense vers {{hour}}.",
     "usageNextMilestone": "Prochain jalon {{value}}",
     "usageMilestoneRemaining": "{{value}} restants",
     ...
     "usageFilterPlaceholder": "Filtrer par modèle, fournisseur, outil ou session",
     "usageClearFilters": "Effacer les filtres",
     "usageModelsTitle": "Modèles",
     "usageModelsHint": "Modèles sur cette période",
     "usageToolsTitle": "Outils",
     "usageToolsHint": "Sources sur cette période",
     "usageSessionsTitle": "Sessions les plus actives",
  ...
  "project": {
    ...
    "sessionsCount_other": "{{count}} sessions",
     ...
     "workbenchLocalChanges": "Modifications locales",
     "workbenchContracts": "Contrats de plan et d’objectif",
     "workbenchClean": "Propre",
     "workbenchChanged": "Modifié",
     "workbenchActivateToInspect": "Activer pour inspecter",
     "workbenchActivateHint": "Activez ce projet pour inspecter son arbre de travail Git actuel.",
     "workbenchDiffUnavailable": "Impossible de lire l’arbre de travail actuel.",
     "workbenchFiles": "fichiers modifiés",
     "workbenchTruncated": "Tronqué",
     "workbenchNoChanges": "Aucune modification locale actuelle.",
     "workbenchNoContracts": "Aucun contrat de plan ou d’objectif associé à ce projet.",
     "workbenchEvidenceHint": "L’état du contrat et les modifications locales sont des éléments de preuve ; un objectif n’est pas terminé automatiquement.",
  ...
  "panel": {
    ...
    "tabs": {
      ...
      "contextVault": "Coffre de contexte",`r`n      "promptInspector": "Contexte du prompt"`r`n    },
    "pluginView": {
