...
export const es = {
  ...
  "chat": {
    ...
    "usageContextAria": "{{percent}}% de contexto restante, quedan {{remaining}} tokens",
    ...
    "permissionFullAccessTerminal": "Terminal: ejecutar comandos sin preguntar cada vez.",
    "permissionFullAccessInternet": "Internet y herramientas conectadas: enviar solicitudes o usar integraciones activadas.",
    "permissionFullAccessSensitiveData": "Datos sensibles: el contenido puede exponerse a herramientas o servicios.",
    "permissionFullAccessPromptInjection": "Inyección de instrucciones: el contenido no confiable puede intentar influir en el agente.",
    "permissionFullAccessConfirm": "Activar acceso total",
    "modePlan": "Plan",
    "modeGoal": "Meta",
    "modeAgent": "Agente",
  ...
  "settings": {
    ...
    "delete": "Eliminar",
    "theme": "Tema",
    "themeFromPlugin": "Tema del complemento",
    ...
    "workspaces": "Espacios de trabajo",
    "workspacesDesc": "Solo árboles de trabajo Git locales administrados por Nexus.",
    "workspacesEmpty": "No hay árboles de trabajo administrados.",
    "workspacesEmptyTitle": "Aún no hay árboles de trabajo administrados",
    "workspacesEmptyBody": "Abre un proyecto; Nexus creará aquí un espacio aislado cuando una tarea lo necesite.",
    "workspaceOpenProject": "Abrir proyecto",
    "workspaceDirectFolder": "Trabajar directamente en esta carpeta",
    "workspaceOpen": "Abrir tarea",
    "workspaceReveal": "Mostrar",
    "workspaceCleanup": "Limpiar",
    "workspaceMissing": "Carpeta no disponible",
    "workspaceDirty": "Cambios sin confirmar",
    "workspaceMerged": "Limpio y fusionado",
    "workspaceActive": "Rama activa",
    "workspaceTasks_one": "{{count}} tarea",
    "workspaceTasks_other": "{{count}} tareas",
    "refresh": "Actualizar",
    "ai": "AI",
    "shortcuts": "Atajos",
    "instructions": "Instrucciones",
    ...
    "nexusWorkflowSkills": "Habilidades de flujo de trabajo de Nexus",
    "nexusWorkflowSkillsPath": "Recursos de la aplicación Nexus",
    "nexusSkillVersion": "Nexus · v{{version}}",
    "nexusSkillReadOnly": "Incluida por Nexus. Solo lectura.",
    "inspectNexusSkill": "Inspeccionar {{name}}",
    "mcp": "Servidores MCP",
    ...
    "themeDesc": "Elige sistema, claro, oscuro o un tema paisajístico.",
    "themeSystem": "Sistema",
    "themeLight": "Claro",
    "themeDark": "Oscuro",
    "themeTwilightMountains": "Montañas del crepúsculo",
    "themeAlpineLight": "Luz alpina",
    "themeSystemDesc": "Siga la configuración del sistema.",
    "themeLightDesc": "Tema claro.",
    "themeDarkDesc": "Tema oscuro.",
    "themeTwilightMountainsDesc": "Tema oscuro de cristal con paisaje.",
    ...
    "fontSizeSaveError": "No se pudo guardar el tamaño de fuente.",
     ...
     "usageHeadline": "Uso de un vistazo",
     "usageTokensInRange": "en el rango seleccionado",
     "usageCompleted": "completados",
     "usageProviderInput": "entrada del proveedor",
     "usageProviderOutput": "salida del proveedor",
     "usageActivity": "Actividad",
     "usageActivityHint": "Volumen de tokens por periodo",
     "usageLatest": "Periodo más reciente",
     "usageLatestHint": "Último periodo completado",
     "usageRange": "Rango de uso",
     "usageDaily": "Diario",
     "usageWeekly": "Semanal",
     "usageMonthly": "Mensual",
     "usageUnavailable": "El historial de uso no está disponible.",
     "usageTotal": "Tokens totales",
     "usageInput": "Tokens de entrada",
     "usageOutput": "Tokens de salida",
     "usageTurns": "Turnos completados",
     "usageHistory": "Historial de uso",
     "usageBreakdown": "Desglose de tokens",
     "usageCacheRead": "Lectura de caché",
     "usageCacheWrite": "Escritura de caché",
     "usageReasoning": "Razonamiento",
     "usageTurnCount_one": "{{count}} turno",
     "usageTurnCount_other": "{{count}} turnos",
     "usageEmpty": "No hay uso completado en este rango.",
     "usageMix": "Distribución de tokens",
     "usageMixHint": "Parte del volumen de turnos completados",
     "usageRhythm": "Ritmo",
     "usageRhythmHint": "Volumen de tokens por periodo",
     "usagePeriods": "periodos",
     "usagePeriodsTitle": "Periodos recientes",
     "usagePeriodsHint": "Actividad de turnos completados",
     "usageTurnsShort": "turnos",
     "usageTurnsTitle": "Turnos completados",
     "usageTurnsHint": "Acumulado persistente del host",
     "usageAverage": "Promedio por turno",
     "usagePluginTitle": "Token Insights",
     "usageHeroSub": "{{turns}} turnos completados · uso local",
     "usageGreeting": "Buenas tardes — esto es lo que tú y tus herramientas habéis escrito.",
     "usageHeroStats": "tokens · {{turns}} respuestas · {{sessions}} sesiones · {{days}} días activos",
     "usageStreak": "racha de {{current}} días",
     "usageLongest": "Máxima {{longest}}",
     "usageMilestoneReached": "{{value}} alcanzados el {{date}}",
     "usageBestDay": "Tu mejor día fue {{date}}, con {{tokens}} tokens. Tu pensamiento más intenso ocurre alrededor de {{hour}}.",
     "usageNextMilestone": "Próximo hito {{value}}",
     "usageMilestoneRemaining": "Faltan {{value}}",
     "usageFilters": "Filtros de uso",
     "usageAllTools": "Todas las herramientas",
     "usageAllModels": "Todos los modelos",
     "usageAllProviders": "Todos los proveedores",
     "usageFilterPlaceholder": "Filtrar por modelo, proveedor, herramienta o sesión",
     "usageClearFilters": "Borrar filtros",
     "usageModelsTitle": "Modelos",
     "usageModelsHint": "Modelos en este periodo",
     "usageToolsTitle": "Herramientas",
     "usageToolsHint": "Fuentes en este periodo",
     "usageSessionsTitle": "Sesiones más activas",
  ...
  "project": {
    ...
    "sessionsCount_other": "{{count}} sesiones",
     ...
     "workbenchLocalChanges": "Cambios locales",
     "workbenchContracts": "Contratos de plan y objetivo",
     "workbenchClean": "Limpio",
     "workbenchChanged": "Modificado",
     "workbenchActivateToInspect": "Activar para inspeccionar",
     "workbenchActivateHint": "Active este proyecto para inspeccionar su árbol de trabajo Git actual.",
     "workbenchDiffUnavailable": "No se pudo leer el árbol de trabajo actual.",
     "workbenchFiles": "archivos modificados",
     "workbenchTruncated": "Truncado",
     "workbenchNoChanges": "No hay cambios locales actuales.",
     "workbenchNoContracts": "No hay contratos de plan u objetivo asociados a este proyecto.",
     "workbenchEvidenceHint": "El estado del contrato y los cambios locales son superficies de evidencia; no completan un objetivo automáticamente.",
  ...
  "panel": {
    ...
    "tabs": {
      ...
      "contextVault": "Bóveda de contexto",`r`n      "promptInspector": "Contexto del prompt"`r`n    },
    "pluginView": {
