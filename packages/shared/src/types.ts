...
export type BrowserActivationRequest = { requestId: string; sessionId: string; location?: string; source: BrowserSource; focus: "panel" | "address" | "toolbar"; background: boolean };
export type BrowserSurfaceStatus = { attachment: "attached" | "detached"; visibility: "visible" | "hidden"; navigation: "unverified" | "loading" | "verified" | "failed"; guestGeneration: number; updatedAt: number };
