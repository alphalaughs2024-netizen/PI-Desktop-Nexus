...
当前 **0.0.x** 版本线包含：桌面外壳、流式智能体运行时、智能体 / 规划 / 目标工作流、带权限的工作区工具、项目与会话、会话导入、本地 MCP 控制、MCP / Skills / 子智能体、后台委派、多服务商模型配置、插件与市场、上下文检查点、通知、scenic 主题、可靠的 Workspaces 管理、更新日志以及跨平台打包。最新版本为 **0.0.5**。
