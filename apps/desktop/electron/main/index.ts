...
function applyNativeThemeSource(settings?: { theme?: unknown } | null) {
  ...
  if (preference === "light" || preference === "dark" || preference === "twilight-mountains" || preference === "alpine-light" || preference === "obsidian-horizon" || preference === "emerald-afterglow") {
    next = preference === "twilight-mountains" || preference === "obsidian-horizon" || preference === "emerald-afterglow" ? "dark" : preference === "alpine-light" ? "light" : preference;
...
function applyApplicationMenuSettings(settings?: {
  ...
  const preference = settings?.theme;
  appThemePreference =
    preference === "light" || preference === "dark" || preference === "twilight-mountains" || preference === "alpine-light" || preference === "obsidian-horizon" || preference === "emerald-afterglow"
      ? preference
  ...
  if (preference === "light" || preference === "dark" || preference === "twilight-mountains" || preference === "alpine-light" || preference === "obsidian-horizon" || preference === "emerald-afterglow") {
    pluginPanelTheme = preference === "twilight-mountains" || preference === "obsidian-horizon" || preference === "emerald-afterglow" ? "dark" : preference === "alpine-light" ? "light" : preference;
  } else if (typeof preference === "string" && preference.startsWith("plugin:")) {
    const pluginTheme = plugins.getThemes().find((theme) => theme.id === preference);
    pluginPanelTheme =
...
function registerIpc() {
  ...
  handle(IPC.invoke.windowSetBackgroundColor, async (input: unknown = {}) => {
    ...
    if (theme !== "light" && theme !== "dark" && theme !== "twilight-mountains" && theme !== "alpine-light" && theme !== "obsidian-horizon" && theme !== "emerald-afterglow") {
    ...
    mainWindow.setBackgroundColor(
      theme === "light" ? "#ffffff" : theme === "twilight-mountains" ? "#071326" : theme === "alpine-light" ? "#d7e5f8" : theme === "obsidian-horizon" ? "#080d16" : theme === "emerald-afterglow" ? "#071a13" : "#181818",
    );
