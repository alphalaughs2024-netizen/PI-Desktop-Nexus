...
export function ProjectCollectionPicker({ projectPath, collections, selected, onClose, onToggle, onCreate, projects = [], assignmentCollectionId, onAssign, anchor }: { projectPath?: string; collections: ProjectCollection[]; selected: string[]; onClose: () => void; onToggle: (id: string, checked: boolean) => void; onCreate: (name: string) => void; projects?: CollectionProjectOption[]; assignmentCollectionId?: string; onAssign?: (projectPath: string, checked: boolean) => void; anchor?: { top: number; left: number } }) {
