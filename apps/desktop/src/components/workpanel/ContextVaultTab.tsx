  ...
  return <section className="context-vault-tab">
    <div className="context-vault-workspace">
      ...
      <div className="context-vault-main">
        <header className="context-vault-toolbar"><label className="context-vault-search-shell"><IconSearch size={15} aria-hidden="true" /><input aria-label={t("contextVault.search")} className="context-vault-search" value={query} onChange={(event) => setQuery(event.target.value)} placeholder={t("contextVault.search")} /></label><div className="context-vault-actions"><button type="button" className="context-vault-action context-vault-action-primary" disabled={actionsDisabled} aria-describedby={actionsDisabled ? "context-vault-operation-status" : undefined} onClick={startClaim}><IconPlus size={15} aria-hidden="true" />{t("contextVault.newClaim")}</button><button type="button" className="context-vault-action context-vault-action-secondary" disabled={actionsDisabled} aria-describedby={actionsDisabled ? "context-vault-operation-status" : undefined} onClick={() => void previewImport()}>{t("contextVault.import")}</button><button type="button" className="context-vault-action context-vault-action-secondary" disabled={actionsDisabled || claims.length === 0} aria-describedby={actionsDisabled ? "context-vault-operation-status" : undefined} onClick={() => void exportVault()}>{t("contextVault.export")}</button></div></header>
        ...
        {(operationLabel || claimsLoading) && <p id="context-vault-operation-status" className="context-vault-message context-vault-notice" role="status">{operationLabel ?? t("common.loading")}</p>}{error && <p className="context-vault-message context-vault-error" role="alert">{error}</p>}{notice && <p className="context-vault-message context-vault-notice" role="status">{notice}</p>}
        {!isEditing && claimsLoading ? <div className="context-vault-empty"><h2>{t("common.loading")}</h2></div> : !isEditing && !visibleClaims.length ? (query || category !== "all" || tag ? <div className="context-vault-empty context-vault-search-empty"><h2>{t("contextVault.noMatchingClaims")}</h2><p>{t("contextVault.emptyBody")}</p><button type="button" className="context-vault-action context-vault-action-secondary" onClick={clearFilters}>{t("common.cancel")}</button></div> : <div className="context-vault-empty"><div className="context-vault-empty-orbit" aria-hidden="true"><span /><span /><span /><div className="context-vault-empty-icon"><IconBookOpen size={32} /></div></div><h2>{t("contextVault.emptyTitle")}</h2><p>{t("contextVault.emptyBody")}</p><button type="button" className="context-vault-action context-vault-action-primary context-vault-empty-action" disabled={actionsDisabled} aria-describedby={actionsDisabled ? "context-vault-operation-status" : undefined} onClick={startClaim}><IconPlus size={15} aria-hidden="true" />{t("contextVault.addFirst")}</button><div className="context-vault-empty-tools"><button type="button" className="context-vault-action context-vault-action-secondary" disabled={actionsDisabled} aria-describedby={actionsDisabled ? "context-vault-operation-status" : undefined} onClick={startUserDecision}>{t("contextVault.userDecision")}</button><button type="button" className="context-vault-action context-vault-action-secondary" disabled={actionsDisabled} aria-describedby={actionsDisabled ? "context-vault-operation-status" : undefined} onClick={() => void previewImport()}>{t("contextVault.import")}</button></div></div>) : <div className={`context-vault-grid${isEditing ? " is-editing" : ""}`}>
