    ...
    >
      ...
      <div className="work-panel-main">
        ...
        <div className="work-panel-body">
          ...
          {!subagentPanel && <WorkPanelResourceHost tabs={tabs} activeTabId={activeTabId} presentation={presentation} sessionId={activeSessionId ?? undefined} blocked={exiting || panelBlocked || contextOpen} transitioning={isPresentationTransitioning} pluginViews={pluginViews} />}
